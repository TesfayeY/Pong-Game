...
score_a = 0
score_b = 0
score_limit = 4  #Change the score limit here
...
ball.penup()
ball.goto(0, 0)
ball.dx = 0.2  # Adjust the value for ball speed
ball.dy = 0.2  # Adjust the value for ball speed
